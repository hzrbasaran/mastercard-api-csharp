...
namespace MasterCard.SDK.Services.MoneySend.Domain
{
    ...
    public partial class UpdateMapping
    {
        [XmlElementAttribute(Order = 1)]
        private int? requestIdField;

        private UpdateMappingMapping mappingField;

        public UpdateMapping()
        {
            this.mappingField = new UpdateMappingMapping();
        }
        ...
        public UpdateMappingMapping Mapping
        {
            get
            {
    ...
    public partial class UpdateMappingMapping
    {
