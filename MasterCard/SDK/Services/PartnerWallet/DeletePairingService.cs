...
{
    class DeletePairingService : Connector
    {
        ...
        public DeletePairingResponse AuthorizeExpressCheckoutResponse(DeletePairingRequest request)
        {
            string response = "";
            ...
            return Serializer<DeletePairingResponse>.Deserialize(response); 
        }
