...
namespace MasterCard.SDK.Services.MoneySend.Domain
{
    ...
    public partial class CreateMapping
    {
        ...
        private CreateMappingMapping mappingField;

        public CreateMapping()
        {
            this.mappingField = new CreateMappingMapping();
        }
        ...
        public CreateMappingMapping Mapping
        {
            get
            {
    ...
    public partial class CreateMappingMapping
    {
