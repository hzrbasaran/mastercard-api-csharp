...
namespace MasterCard.SDK.Services.MDES.Domain
{
    ...
    public partial class TransactionRequest
    {
        ...
        private TransactionRequestAuditInfo auditInfoField;

        public TransactionRequest()
        {
            this.auditInfoField = new TransactionRequestAuditInfo();
        }
        ...
        public TransactionRequestAuditInfo AuditInfo
        {
            get
            {
    ...
    public partial class TransactionRequestAuditInfo
    {
